...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { language_code: @language.language_code, language_name: @language.language_name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { language_code: @language.language_code, language_name: @language.language_name } }
